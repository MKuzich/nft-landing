const Modal = ({ children, toggleModal }) => {
  return (
    <div className="backdrop">
      ...
      <div className="absolute flex justify-center w-11/12 tablet:w-99 desktop:w-100 py-10 tablet:py-12 desktop:py-16 px-8 tablet:px-16 desktop:px-20 bg-slate-100 dark:bg-slate-900 rounded-xl left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2">
        <button
