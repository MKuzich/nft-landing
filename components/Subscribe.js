      ...
      <div className="py-6 tablet:py-9 desktop:py-11 bg-gradient-to-r from-indigo-300 to-teal-300 container mx-auto">
        <Container>
          <div className="flex justify-center relative px-5 tablet:px-0">
            <form className="relative py-10 px-8 desktop:px-20 z-10 w-full tablet:w-3/4 desktop:w-2/3 bg-slate-700 rounded-xl">
              ...
              />
              <div className="bg-gradient-to-r from-white/60 to-transparent h-0.5 w-5/6 desktop:w-11/12"></div>
